 ...
 */
public class AnimatedSvgView extends View implements WoWoAnimationInterface {
  ...
  protected void onDraw(Canvas canvas) {
    ...
    long t = (long) ((mTraceTime + mFillTime) * mProcess);
    ...
    if (t > 0) {
      ...
      float phase = constrain(0, 1, (t - mTraceTime) * 1f / mFillTime);
      for (int i = 0; i < mGlyphData.length; i++) {
    ...
    if (t > mTraceTime + mFillTime) changeState(STATE_FINISHED);
  }
