...
public class WoWoPosition3DAnimation extends XYZPageAnimation {
    ...
    public WoWoPosition3DAnimation(int page, float startOffset, float endOffset, Ease ease, boolean useSameEaseEnumBack, float fromX, float fromY, float fromZ, float toX, float toY, float toZ) {
    ...
    public static class Builder extends XYZPageAnimation.Builder<WoWoPosition3DAnimation.Builder> {
        ...
        public WoWoPosition3DAnimation build() {
            ...
            return new WoWoPosition3DAnimation(page, startOffset, endOffset, ease, useSameEaseEnumBack, fromX, fromY, fromZ, toX, toY, toZ);
        }
    }
}
